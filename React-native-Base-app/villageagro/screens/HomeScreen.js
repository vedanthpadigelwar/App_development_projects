  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.sliderContainer}>
        <Swiper
          ...
          activeDotColor="#FF6347">
            <TouchableOpacity style={styles.about_your_crop_button} onPress={() => alert("Button clicked")}>
      ...
      <View style={[styles.categoryContainer, {marginTop: 10}]}>
        ...
        <TouchableOpacity style={styles.categoryBtn} onPress={() => alert("Button clicked")}>
          <View style={styles.categoryIcon}>
            <Image
